...
export async function createAnagramPuzzleMaker(words: string[]): Promise<AnagramPuzzleMaker>;
export async function createAnagramPuzzleMaker(filePath?: string): Promise<AnagramPuzzleMaker>;
...
export async function createAnagramPuzzleMaker(
    ...
    return new AnagramPuzzleMaker(words);
}
